...
# The data files in condensed folder do not replicate rows for national measures
source_dir = "/grpshares/hitsch_shapiro_ads/data/Ad_Intel/aggregated_condensed"
